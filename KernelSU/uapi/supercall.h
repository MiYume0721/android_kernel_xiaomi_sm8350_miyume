...
struct ksu_enable_kpm_cmd {
    __u8 enabled; // Output: true if KPM compatibility is enabled
};
...
#else
// 102 = ENABLE_KPM (KernelPatch Module), unavailable when CONFIG_KPM is off
#endif
...
#else
// 200 = MANAGE_KPM, unavailable when CONFIG_KPM is off
#endif
